...
public class Application {
	...
	public void signUp() throws SQLException {
		...
		if(mc.signUp(member)) System.out.println("성공적으로 회원가입 완료하였습니다."); // true면 "성공적으로 회원가입 완료하였습니다." 출력
		else {
			System.out.println("중복된 아이디입니다. 다시 입력해주세요."); // false면 "중복된 아이디입니다. 다시 입력해주세요." 출력
			signUp();
		}
	}
	...
	public void changePassword() throws SQLException {
		...
		if(mc.changePassword(member, newPassword)) System.out.println("비밀번호 변경에 성공했습니다.");
	...
	public void changeName() throws SQLException {
		...
		// 이름이 null이 아니면 
		//  --> "현재 설정된 이름 : OOO" 출력
		if(name != null) System.out.println("현재 설정된 이름 : " + name);
		...
		name = mc.changeName(member);
		if(name != null) System.out.println("이름 변경에 성공하였습니다.");
